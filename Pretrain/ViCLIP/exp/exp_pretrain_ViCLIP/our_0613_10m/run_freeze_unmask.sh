...
JOB_NAME='our_230613_10m_resized_freeze_unmask'
# JOB_NAME='debug'
...
srun -p ${PARTITION} \
    ...
    pretrained_path phdd:s3://liyizhuo/projects/vindlu/exp/exp_pretrain_videoclip/our_230613_10m/our_230613_10m_resized_freeze/ckpt_best.pth \
