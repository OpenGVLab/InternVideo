...
JOB_NAME='our_0613_filtered_30p_10m_freeze_unmask'
# JOB_NAME='debug'
...
srun -p ${PARTITION} \
    ...
    pretrained_path phdd:s3://liyizhuo/projects/vindlu/exp/exp_pretrain_videoclip/our_0613_filtered_30p_10m/our_0613_filtered_30p_10m_freeze/ckpt_best.pth \
    output_dir ${OUTPUT_DIR} \
    optimizer.lr 4e-6 \
