...
from engines.engine_for_stage2 import train_one_epoch
...
def get_args():
    ...
    parser.add_argument('--stage1_checkpoint', default='', type=str)
...
def main(args, ds_init):
    ...
    if args.stage1_checkpoint != "":
        sd = torch.load(args.stage1_checkpoint, map_location='cpu', weights_only=False)['module']
        msg = model_without_ddp.load_state_dict(sd, strict=False)
        print(f'Loading from {args.stage1_checkpoint}, MESSAGE: {msg}')
    
    target_encoder = copy.deepcopy(model_without_ddp)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            ...
            clip_teacher_model=target_encoder, 
            clip_input_frame=args.num_frames,
