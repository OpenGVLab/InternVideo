...
class DistInternVideo2(nn.Module):
    def __init__(
            ...
            clip_student_decoder: str = 'Linear_Decoder',
        ):
        super().__init__()
    ...
    def forward(self, x, mask=None):
        ...
        return x_clip_align, x_align
    

@register_model
def distill_internvideo2_small_patch14_224(pretrained=False, **kwargs):
    model = DistInternVideo2(
...
@register_model
def distill_internvideo2_base_patch14_224(pretrained=False, **kwargs):
    model = DistInternVideo2(
...
@register_model
def distill_internvideo2_large_patch14_224(pretrained=False, **kwargs):
    model = DistInternVideo2(
...
if __name__ == '__main__':
    ...
    model = distill_internvideo2_small_patch14_224(clip_return_layer=1).cuda().half()
    print(model)
