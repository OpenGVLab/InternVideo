    ...
    for step, batch in enumerate(metric_logger.log_every(data_loader, print_freq, header)):
        ...
        with torch.no_grad():
            ...
            if mask_type == 'attention':
                ...
                bool_masked_pos = torch.ones((B, N))
                pos1 = torch.arange(B).view(-1, 1).repeat(1, N_vis)
        ...
        if loss_scaler is None:
            ...
            outputs_clip_middle, outputs_clip_final = model(videos, bool_masked_pos)
        ...
        loss = loss_clip_middle * clip_loss_ratio[0] + loss_clip_final * clip_loss_ratio[1]
