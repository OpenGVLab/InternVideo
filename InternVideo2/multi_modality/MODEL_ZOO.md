...
| $\text{InternVideo2}_{clip}$-S14 | IV-25.5M Distillation |  [:hugs: HF link](TBD) | [script](scripts/pretraining/clip/S14/run.sh) |
| $\text{InternVideo2}_{clip}$-B14 | IV-25.5M Distillation |  [:hugs: HF link](TBD) | [script](scripts/pretraining/clip/B14/run.sh) |
| $\text{InternVideo2}_{clip}$-L14 | IV-25.5M Distillation |  [:hugs: HF link](TBD) | [script](scripts/pretraining/clip/L14/run.sh) |
