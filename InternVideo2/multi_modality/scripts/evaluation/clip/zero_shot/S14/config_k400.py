...
model = dict(
    ...
    vision_ckpt_path=f"{_MODEL_PATH}/S14_dist_1B_stage2.pth",
...
# pretrained_path = ""
pretrained_path = {
    "/mnt/petrelfs/likunchang/code/open_source/internvideo2/multi_modality/scripts/pretraining/clip/small/stage1_freezeProjection_loadMLPS2/ckpt_01.pth/mp_rank_00_model_states.pt": 0.5,
    "/mnt/petrelfs/likunchang/code/open_source/internvideo2/multi_modality/scripts/pretraining/clip/small/stage1_freezeProjection_loadMLPS2/ckpt_02.pth/mp_rank_00_model_states.pt": 0.5,
}  
