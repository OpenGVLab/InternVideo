...
from .internvideo3_config import InternVideo3ProjectorConfig
...
class InternVideo3VisionPatchMerger(nn.Module):
    config: InternVideo3ProjectorConfig

    def __init__(self, config: InternVideo3ProjectorConfig, use_postshuffle_norm=False) -> None:
        super().__init__()
...
class InternVideo3Projector(BaseModel):
    config: InternVideo3ProjectorConfig

    def __init__(self, config: InternVideo3ProjectorConfig) -> None:
        super().__init__(config)  # type: ignore[arg-type]
        self.merger = InternVideo3VisionPatchMerger(config, use_postshuffle_norm=False)
