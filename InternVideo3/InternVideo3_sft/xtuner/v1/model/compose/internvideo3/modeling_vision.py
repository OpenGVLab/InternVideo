...
from .internvideo3_config import InternVideo3VisionConfig
...
class InternVideo3VisionMLP(nn.Module):
    def __init__(self, config: InternVideo3VisionConfig):
        super().__init__()
...
class InternVideo3VisionLayer(nn.Module):
    def __init__(self, config: InternVideo3VisionConfig) -> None:
        super().__init__()
...
class InternVideo3VisionModel(BaseModel):
    ...
    def __init__(self, config: InternVideo3VisionConfig) -> None:
        ...
        self.patch_embed = InternVideo3VisionPatchEmbed(config=config)
        ...
        self.blocks = nn.ModuleList([InternVideo3VisionLayer(config) for _ in range(config.depth)])
    ...
    def build_rotary_embedding(self, config: InternVideo3VisionConfig):
        head_dim = config.hidden_size // config.num_attention_heads
        return InternVideo3VisionRotaryEmbedding(head_dim // 2)
