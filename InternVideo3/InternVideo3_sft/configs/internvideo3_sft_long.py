...
# These defaults follow the long/debug SFT recipe in the reference xtuner config.
sample_max_length = 32768 * 2 * 4
pack_max_length = 32768 * 2 * 4
num_workers = 2
global_batch_size = 8
total_epoch = 1
hf_interval = 100
...
video_max_total_pixels = 32768 * 4 * 32 * 32 * 4
video_min_frames = 4
