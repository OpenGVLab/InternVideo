...
export model_args="pretrained=${model_path},min_pixels=${MIN_PIXELS},max_pixels=${MAX_PIXELS},fps=4,max_num_frames=128,attn_implementation=flash_attention_2"
export model='internvideo3'
export benchmark='mmmu_val'
